...
export default function Home() {
  ...
  function openOrCloseSubmitModal() {
  ...
  return (
      <div className="bg-white">
          ...
          <div className="mx-auto max-w-2xl py-24 sm:py-36 lg:py-48">
            ...
            <div className="text-center">
              ...
              <button
                  ...
                  onClick={openOrCloseSubmitModal}
                >
                  Submit a Track
                </button>
                <Link
                ...
                >
                  Review a Track <span aria-hidden="true">→</span>
                </Link>
              </div>
            </div>
          </div>
        ...
        <SubmitModal isOpen={isSubmitOpen} openOrCloseModal={openOrCloseSubmitModal} />
      </div>
  );
}

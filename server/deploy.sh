...
# build docker iamge
docker build -t 837765293758.dkr.ecr.us-east-2.amazonaws.com/beta-test-songs-repo-prod:$image_tag -t 837765293758.dkr.ecr.us-east-2.amazonaws.com/beta-test-songs-repo-prod:latest . 

# push image to ecr
docker push 837765293758.dkr.ecr.us-east-2.amazonaws.com/beta-test-songs-repo-prod:$image_tag
docker push 837765293758.dkr.ecr.us-east-2.amazonaws.com/beta-test-songs-repo-prod:latest
